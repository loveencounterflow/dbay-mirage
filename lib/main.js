...
create view ${prefix}_pars as select distinct
    ...
    raise( fail, '^mirage@3^ not allowed to modify table ${prefix}_mirror for trk = 1' ) end;
      ...
      _compile_sql() {
        ...
        GUY.props.hide(this, 'sql', {
          ...
          //.....................................................................................................
          append_text: SQL`insert into ${prefix}_mirror ( dsk, oln, trk, txt )
  ...
  returning *;`
      ...
      //---------------------------------------------------------------------------------------------------------
      append_text(cfg) {
        var R, dsk, i, len, line, lines, prefix, text, trk;
        ...
        for (i = 0, len = lines.length; i < len; i++) {
          line = lines[i];
          R.push(this.allowing_change_on_mirror(() => {
            return this.db.first_row(this.sql.append_text, {
              dsk,
              trk,
              text: line
            });
