(function() {
  'use strict';
  var CND, GUY, ITXH, PATH, SQL, URL, badge, debug, echo, help, info, isa, rpr, type_of, types, urge, validate, validate_list_of, warn, whisper;
...
insert into ${prefix}_mirror ( dsk, oln, pce, xtra, txt )
  ...
  returning *;`,
      ...
      append_text(cfg) {
        ...
        debug('^234234^', this.db.all_rows(SQL`select * from ${prefix}_next_free_oln`));
        return null;
      }
      ...
      _refresh_datasource(cfg) {
        ...
        if (force || (digest !== current_digest)) {
          //.....................................................................................................
          this.db(() => {
            var insert_line, line, oln, ref, txt;
