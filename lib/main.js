...
create index ${prefix}_raw_mirror_txt on ${prefix}_raw_mirror ( txt );`);
  ...
  returning *;`,
          //.....................................................................................................
          append_text_to_raw_mirror: SQL`insert into ${prefix}_raw_mirror ( dsk, oln, trk, par, txt )
  ...
  returning *;`
      ...
      _refresh_datasource(cfg) {
        ...
        var counts, current_digest, digest, dsk, force, path, prefix, trim_line_ends, url;
        ...
        if (force || (digest !== current_digest)) {
          //.....................................................................................................
          this.db(() => {
            var insert_line_into_mirror, insert_line_into_raw_mirror, line, oln, par, ref, txt, within_par;
