...
insert into ${prefix}_html_mirror ( dsk, oln, col, trk, pce, typ, tag, atrid, txt )
  ...
  returning *;`),
      ...
      _get_non_html_tags() {
        return new Set(this.mrg.db.all_first_values(SQL`select * from ${this.cfg.prefix}_html_tags where syntax != 'html';`));
      }
      ...
      parse_dsk(cfg) {
        ...
        this.mrg.db.with_transaction(() => {
          ...
          for (y of ref) {
            ({oln1, wslc, trk, txt} = y);
            tokens = this.HTMLISH.parse(txt, this._get_non_html_tags());
            ...
            results.push((function() {
              ...
              for (_ = j = 1, ref2 = wslc + 1; (1 <= ref2 ? j <= ref2 : j >= ref2); _ = 1 <= ref2 ? ++j : --j) {
                results1.push(this._append_tag(dsk, oln != null ? oln : oln1, col != null ? col : 1, trk, 'b', null, null, '\n'));
              }
              return results1;
            }).call(this));
          }
