...
insert into ${prefix}_html_mirror ( dsk, tid, sgl, tag, atrid, text )
  ...
  returning *;`),
      ...
      _append_tag(dsk, sgl, tag, atrs = null, text = null) {
        ...
        return this.mrg.db.first_row(this.statements.insert_content, {dsk, sgl, tag, atrid, text});
      }
      ...
      //---------------------------------------------------------------------------------------------------------
      parse_dsk(cfg) {
        var d, dsk, i, len, par, ref1, rwn1, rwn2, tokens, txt, y;
        ...
        for (y of ref1) {
          ...
          for (i = 0, len = tokens.length; i < len; i++) {
            ...
            switch (d.$key) {
              case '^text':
                urge('^4564^', this._append_tag(dsk, '^', '$text', null, d.text));
                break;
              case '^comment':
                urge('^4564^', this._append_tag(dsk, '^', '$comment', null, d.text));
                break;
              case '<tag':
                urge('^4564^', this._append_tag(dsk, '<', d.name, d.atrs));
                break;
              case '>tag':
                urge('^4564^', this._append_tag(dsk, '>', d.name, d.atrs));
                break;
