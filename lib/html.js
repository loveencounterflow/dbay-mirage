(function() {
  'use strict';
  var CND, GUY, HDML, HTMLISH, Htmlish, PATH, SQL, TIMETUNNEL, _HTMLISH, badge, debug, echo, freeze, help, info, isa, lets, rpr, type_of, types, urge, validate, validate_list_of, warn, whisper, xncr;
