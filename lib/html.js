...
create index ${prefix}_html_mirror_tag_idx on ${prefix}_html_mirror ( tag );`);
  ...
  order by t.dsk, t.oln, t.trk, t.pce;`);
      ...
      _procure_infradata() {
        /* TAINT skip if tables found */
        var db, insert_syntax, insert_tag, prefix, seen_syntaxes;
        ({prefix} = this.cfg);
        ({db} = this.mrg);
        ({insert_syntax, insert_tag} = this.statements);
        seen_syntaxes = new Set();
        //.......................................................................................................
        db(() => {
          var d, error, i, is_block, is_empty, len, ref, ref1, results, syntax, tag;
          try {
            ref = (require('./data-html5-tags')).tags;
            results = [];
            ...
            error = error1;
            throw new db.E.DBay_internal_error('^mirage-html@1^', `when trying to insert ${rpr(d)} or ${rpr({syntax})}, an error occurred: ${error.message}`);
          }
        });
        //.......................................................................................................
        return null;
  ...
  where ( syntax != 'html' ) or ( is_block ) or ( is_empty );`);
      ...
      parse_dsk(cfg) {
        ...
        this.mrg.db.with_transaction(() => {
          var _, atrs, col, d, i, len, oln, oln1, ref, ref1, results, tokens, trk, txt, wslc, y;
          ...
          for (y of ref) {
            ...
            for (i = 0, len = tokens.length; i < len; i++) {
              ...
              switch (d.$key) {
                case '<tag':
                  this._append_tag(dsk, oln, col, trk, '<', d.name, d.syntax, d.atrs);
                  break;
                case '>tag':
                  this._append_tag(dsk, oln, col, trk, '>', d.name, d.syntax, d.atrs);
                  break;
                case '^tag':
                  ...
                  break;
                case '^text':
                  this._append_tag(dsk, oln, col, trk, 't', null, d.syntax, null, d.text);
                  break;
                case '^comment':
                case '^doctype':
                  this._append_tag(dsk, oln, col, trk, 'r', null, d.syntax, null, d.text.replace(/^<!--\s*(.*?)\s*-->$/, '$1'));
                  break;
                case '^error':
                  ...
                  this._append_tag(dsk, oln, col, trk, 'e', null, d.syntax, atrs, `${d.message}: ${rpr(d.text)}`);
                  break;
                default:
            ...
            results.push((function() {
              ...
              for (_ = j = 1, ref2 = wslc + 1; (1 <= ref2 ? j <= ref2 : j >= ref2); _ = 1 <= ref2 ? ++j : --j) {
                results1.push(this._append_tag(dsk, oln != null ? oln : oln1, col != null ? col : 1, trk, 'b', null, d.syntax, null, '\n'));
              }
              return results1;
            }).call(this));
          }
